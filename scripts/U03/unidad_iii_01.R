...
fechas <- html |> html_elements(css = '.row-gap-tablet-3 .com-date.--fourxs') |> html_text2()
...
titulares <- html |> html_elements(css = '.hlp-degrade .mod-description h2') |> html_text2()

# Imprimir 
titulares

# Selección de los nodos de los links
links <- html |> html_elements(css = '.hlp-degrade .mod-description h2 a') |> html_attr("href") |> url_absolute(url)
